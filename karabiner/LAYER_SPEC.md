...
**右手**:
- **F**: 長押し→Right Control、短押し→F
- **G**: 長押し→Left Command、短押し→G
- **V**: 長押し→Right Shift、短押し→V
...
|------|------|------|
| **上段（数字行）** |||
| Q | 長押し→Left Alt、短押し→` | バッククォート・ホームロウ修飾キー |
| W | 7 | テンキー上段左 |
| E | 8 | テンキー上段中 |
| R | 9 | テンキー上段右 |
| T | 0 | テンキー0 |
...
| P | ; | セミコロン |
| **中段（ホーム行）** |||
| A | 長押し→Right Command、短押し→- | マイナス・ホームロウ修飾キー |
| S | 4 | テンキー中段左 |
| D | 5 | テンキー中段中 |
| F | 6 | テンキー中段右 |
| G | = | イコール・演算子 |
...
| L | 6 | テンキー（重複） |
| **下段** |||
| Z | 長押し→Left Shift、短押し→= | イコール・ホームロウ修飾キー |
| X | 1 | テンキー下段左 |
| C | 2 | テンキー下段中 |
| V | 3 | テンキー下段右 |
| B | . | 小数点 |
...
| W | 水平スクロール左 | マウス横スクロール（左） |
| E | 垂直スクロール下 | マウス縦スクロール（下） |
| R | 水平スクロール右 | マウス横スクロール（右） |
...
| P | Insert | 挿入モード |
| **中段（ホーム行）** |||
| A | 長押し→Right Command、短押し→- | 複合機能・ホームロウ修飾キー |
| S | 長押し→Left Control、短押し→Enter | 複合機能・ホームロウ修飾キー |
| D | 垂直スクロール上 | マウス縦スクロール（上） |
| F | 左クリック(Button1) | マウス主クリック |
